...
require("packer").startup(function()
  ...
  require("nvim-treesitter.configs").setup({
    ensure_installed = { "c", "lua", "rust", "javascript", "java", "json", "html", "css", "bash", "python", "php"},
    highlight = {
      enable = false,
    },
  })
...
-- prueba a ver si puedo buscar así 
vim.api.nvim_set_keymap("n", "<leader><leader>", "/", { noremap = true })
-- si se pudo
vim.api.nvim_set_keymap("n", "<leader>ll", ":noh<CR>", { noremap = true })
-- compile java 
vim.api.nvim_set_keymap("n", "<leader>r", "<cmd>split | term java %<CR>", { noremap = true })
